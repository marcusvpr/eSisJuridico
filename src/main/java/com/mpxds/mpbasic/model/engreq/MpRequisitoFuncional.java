...
@Entity
@Audited
@AuditTable(value="mp_er_requisito_funcional_")
@Table(name = "mp_er_requisito_funcional")
public class MpRequisitoFuncional extends MpBaseEntity {
	//
	...
	private String associacao; // FC.CLI.0001 FC.USU.0005 -> separados por ESPAÇOS !
	...
	@NotNull(message = "Por favor, informe a Funcionalidade")
	@OneToOne(fetch = FetchType.EAGER) 
	...
	public String getIdRF() { return idRF; }
	public void setIdRF(String idRF) { this.idRF = idRF; }
