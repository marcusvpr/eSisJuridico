...
public class MpJsfRedirectStrategy implements RedirectStrategy {
     ...
     * context path. Note that this will result in the loss of protocol information (HTTP or HTTPS), 
     * so will cause problems if a redirect is being performed to change to HTTPS, for example.
     */
