...
@Named
@ViewScoped
public class MpCalendarioViewBeanBK implements Serializable {
	//
...
//	private Boolean indCarga = false;
	...
	public void init() {
		//
		System.out.println("MpCalendarioViewBean.init() - Entrou.000");
		//
		// Locale ptBr = new Locale("ptBR", "BR"); //Locale para o Brasil
		
//		if (this.getIndCarga()) return;
//		//
//		this.setIndCarga(true);
//		
...
//		this.eventModel.addEvent(new DefaultScheduleEvent("XXXXXXX", new Date(), new Date()));
//		
...
////				addEvent(new DefaultScheduleEvent("Lazy Event MPXDS", random, random));
//			}
//		};
	}
...
//	}
	...
	public void inicializar() {
		//
		System.out.println("MpCalendarioViewBean.inicializar() - Entrou.000");
...
//	public Boolean getIndCarga() { return indCarga; }
//	public void setIndCarga(Boolean indCarga) { this.indCarga = indCarga; }
