 ...
 *         &lt;element name="ds_resposta" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "responderExigencia")
public class ResponderExigencia {
    ...
    @XmlElementRef(name = "ds_resposta", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> dsResposta;
    ...
    /**
     * Obtém o valor da propriedade dsResposta.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getDsResposta() {
        return dsResposta;
    }

    /**
     * Define o valor da propriedade dsResposta.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setDsResposta(JAXBElement<String> value) {
        this.dsResposta = value;
    }
